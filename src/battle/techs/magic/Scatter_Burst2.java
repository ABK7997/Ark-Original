...
public class Scatter_Burst2 extends Spell {
	...
	public Scatter_Burst2(Playable p) {
		this.p = p;
		x = w/2;
		y = 0;
		name = "Scatter Burst+";
		...
		type = "Offensive";
		range = "Random";
		description = "Hit 3 random targets with moderate magic bursts";
	}
