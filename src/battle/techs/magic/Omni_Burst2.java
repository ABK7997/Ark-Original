...
public class Omni_Burst2 extends Spell {

	private int x1, x2, x3, x4;
	private int y1, y2, y3, y4;
	
	public Omni_Burst2(Playable p) {
		this.p = p;
		x = w/2;
		y = 0;
		name = "Omni-Burst+";
		...
		type = "Offensive";
		range = "All";
		description = "Hit all foes with moderate magic bursts";
	}
