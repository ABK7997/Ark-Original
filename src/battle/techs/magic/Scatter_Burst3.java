...
public class Scatter_Burst3 extends Spell {
	...
	public Scatter_Burst3(Playable p) {
		this.p = p;
		x = w/2;
		y = 0;
		name = "Scatter Burst++";
		...
		type = "Offensive";
		range = "Random";
		description = "Hit 3 random targets with great magic bursts";
	}
	...
	public void animate(Graphics g) {
		...
		if (anim < 32);
			...
			g.fillOval(x1, y1, 125, 125);
			g.fillOval(x2, y2, 125, 125);
			x+=7;
			x1+=7;
			x2+=7;
			y1+=3;
