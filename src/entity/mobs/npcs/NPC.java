...
public class NPC extends Mob {
	...
	protected char c; //Behavior type
	...
	protected STATE state = STATE.ANIMATING;
	...
	public void render(Screen screen) {
		if (Game.State == Game.STATE.GAME || Game.State == Game.STATE.ANIMATING) {
			if (dir == 0) { //Up
				sprite = up;
				if (walking) {
					if (anim % 40 > 20) {
	...
	protected void behavior() {
		if (c == 'x') xBehavior(point1, point2);
		else if (c == 'y') yBehavior(point1, point2);
		else walking = false;
	}
